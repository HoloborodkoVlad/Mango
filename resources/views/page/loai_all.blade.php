						...
						<form role="submit" method="get" id="searchform" action="{{route('all')}}">
							<div class="container ">
								<div class="container-fluid ">
									<a name="low" href="{{route('low')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати від &darr; ціни</a>
									<a name="up" href="{{route('up')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати від &uarr; ціни</a>
									<a name="abc" href="{{route('abc')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати з A до&rarr;Я</a>
									<a name="zyx" href="{{route('zyx')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати з Я до&rarr;A</a>
									<a name="zyx" href="{{route('latest')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати за датою</a>
									<a name="zyx" href="{{route('popular')}}"  class="btn btn-secondary navbar-btn col-md-2">Сортувати за популярністю</a>
								</div>
							</div>
						</form>
					</div>
