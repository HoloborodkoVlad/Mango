...
@section('main')
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Замовник</h1>
			</div>
		</div><!--/.row-->
<?php
			...
			<div class="panel-heading">
				<form role="submit" method="get" id="searchform" action="{{asset('admin/customer/')}}">
					...
					<div class="form-group">
						<a href="{{asset('admin/customer/add')}}" class="btn btn-primary form-control">Додати клієнта</a>
					</div>
					<div class="panel-body">
						<div class="bootstrap-table">
							<div class="table-responsive">
		<div class="beta-products-details ">
			<p class="pull-right">{{count($cuslist)}} елемент знайдено</p>
			<div class="clearfix"></div>
								...
								<table class="table table-bordered" style="margin-top:20px;">				
									<thead>
										<tr class="bg-primary">
											<th>ID</th>
											<th width="15%">Ім'я клієнта</th>
											<th>Стать</th>
											<th width="15%">електронною пошта</th>
											{{-- <th>Пароль</th> --}}
