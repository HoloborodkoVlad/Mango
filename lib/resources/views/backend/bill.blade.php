...
?>		
		...
		<form role="submit" method="get" id="searchform" action="{{asset('admin/bill')}}">
			...
			<button type="submit"  class="form-control"> Пошук</button>
		</form>
					</div>
			<div class="beta-products-details">
				<p class="pull-right">{{count($bilist)}} елемент знайдено</p>
				<div class="clearfix"></div>
			</div>
					<div class="panel-body">
						<div class="bootstrap-table">
							<div class="table-responsive">
								{{-- <a href="{{asset('admin/bill/add')}}" class="btn btn-primary">Додати рахунок</a> --}}
